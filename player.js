...
var mansi = {
    "song": [{
            ...
            "name": "Dil ko karar avya",
            "source": "Dil ko karar avya.wav",
        ...
        //----------------------------------------------------------------------------------------
        {
            ...
            "name": "Soch na sake",
            "source": "Soch na sake.wav",
            "image": "https://i.scdn.co/image/ab67616d0000b27300a1a948e2848d28c4538fe1",
            "singer": "Tulsi Kumar"

        }, {
            "name": "Khushi ke pal kahan dhundhu",
            "source": "Khushi ke pal kahan dhundhu.wav",
        ...
        //----------------------------------------------------------------------------------------
        {
            ...
            "name": "Badtameez Dil",
            "source": "Badtameez Dil.wav",
            "image": "https://www.pagalworld.pw/GpE34Kg9Gq/7920/thumb-yeh-jawaani-hai-deewani-2013-300.jpg",
            "singer": "Benny Dayal Shefali Alvaris"

        }, {
            "name": "Kar Gayi Chull",
            "source": "Kar Gayi Chull.wav",
            ...
            "source": "Main Tera Boyfriend.wav",
            ...
            "source": "Abhi Toh Party Shuru Hui Hai  .wav",
        ...
        //----------------------------------------------------------------------------------------
        {
            ...
            "source": "Dil Ko Karaar Aaya.wav",
            "image": "https://www.pagalworld.pw/GpE34Kg9Gq/113462/143979-dil-ko-karaar-aaya-neha-kakkar-mp3-song-300.jpg",
            "singer": "Neha Kakaar"

        }, {
            "name": "Dil Galti Kar Baitha Hai",
            "source": "Dil Galti Kar Baitha Hai.wav",
            ...
            "name": "Lagann Laagil (Sufi Version)",
            "source": "Lagann Laagil.wav",
...
// const songs = ['ikson', 're', 'song']

let songIndex = 3;

loadsong(mansi["song"][songIndex])

function loadsong(song) {
    title.innerText = mansi["song"][songIndex]["name"];
    audio.src = `music/${mansi["song"][songIndex]["source"]}`;
    cover.src = `${mansi["song"][songIndex]["image"]}`;
    singer.innerHTML = `${mansi["song"][songIndex]["singer"]}`
...
function nextSong() {
    songIndex++;
    if (songIndex > mansi["song"].length - 1) {
        songIndex = 0;
    }
    loadsong(mansi["song"][songIndex]);
    playSong()
